...
export function WhyAyurVedaSection() {
  return (
    <section className="py-20 sm:py-28 bg-white border-b border-brand-brown-border overflow-hidden">
      <Container size="xl">
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative aspect-[4/5] rounded-sm overflow-hidden shadow-2xl border-4 border-brand-cream">
              ...
              <div className="absolute bottom-6 left-6 right-6 text-white space-y-2">
                <span className="text-xs font-serif italic text-brand-gold-light uppercase tracking-widest">
                  Sanctuary of Healing
                </span>
                <p className="font-serif text-xl font-normal text-white leading-snug">
              ...
              {PILLARS.map((pillar, idx) => {
                ...
                return (
                  <div key={idx} className="space-y-2.5 p-4 rounded-sm bg-brand-cream border border-brand-brown-border/60">
                    ...
                    <h4 className="font-serif text-lg font-medium text-brand-brown">
                      {pillar.title}
                    </h4>
